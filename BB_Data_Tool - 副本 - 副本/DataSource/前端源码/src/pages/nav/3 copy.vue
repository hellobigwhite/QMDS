<template>
  ...
  <el-card>
    <div style="display: flex; justify-content: end; align-items: center; gap: 10px;">
      ...
      <el-button type="default" plain @click="handleBatchDelete" :disabled="multipleSelection.length === 0" size="small">
        批量删除
      </el-button>
  ...
  <el-pagination background layout="prev, pager, next" :current-page="currentPage" :page-size="pageSize" :total="total"
    @current-change="handlePageChange" style="margin-top: 20px; text-align: right;"></el-pagination>
...
const editForm = ref<Tag>({ id: 0, name: '' });
